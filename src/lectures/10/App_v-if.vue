<template>
	<div>
		...
		<hr />
		<button v-on:click="type = 'A'">Atoggle</button>
		<button v-on:click="type = 'B'">Btoggle</button>
		<button v-on:click="type = 'C'">Ctoggle</button>
		<button v-on:click="type = 'D'">Dtoggle</button>
